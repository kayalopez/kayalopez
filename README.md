...
- [Supabase Data API grants deadline checklist](https://github.com/kayalopez/ai-agent-launch-tools/blob/main/checklists/supabase-data-api-grants-deadline-checklist.md) - review generated migrations, Lovable/v0-style Supabase apps, and new tables before missing grants or broad fixes create launch risk.
...
- [AI Agent Launch Tools v0.1.26](https://github.com/kayalopez/ai-agent-launch-tools/releases/tag/v0.1.26) - dependency-free public scanner and CLIs for AI-agent, MCP, and Supabase launch hygiene.
