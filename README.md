...
- [AI Agent Launch Tools v0.1.24](https://github.com/kayalopez/ai-agent-launch-tools/releases/tag/v0.1.24) - dependency-free public scanner and CLIs for AI-agent, MCP, and Supabase launch hygiene.

Run the Supabase anonymous RLS check on redacted policy SQL or launch notes:
